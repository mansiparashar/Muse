...
# from flaskapp.main.nlp import get_sentiment_score, get_document , get_score
from flaskapp.main.nlp import  get_score
...
def post():
    ...
    if form.validate_on_submit():
        ...
        score = get_score(form.content.data)
